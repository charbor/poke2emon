...
for mon in pokemon_list:
    ...
    prompt_text = (
        ...
        f"Left column: front-facing battle sprite (3/4 view from the front, idle combat stance). "
        f"Center column: back-facing battle sprite (3/4 view from behind, same combat stance as the front sprite). "
        f"Right column: front-facing T-pose for rigging — the creature seen from the FRONT (stomach-facing the viewer) "
